    ...
    <Box display="flex" justifyContent="center" alignItems="center" minHeight="100vh">
      <Box className="m-6 sm:m-4" maxWidth="800px" width="100%">
        ...
        {state.cart.length === 0 ? (
          ...
          <>
          <p className="text-center sm:text-left">Cantidad de tiquetes: {state.cart.reduce((acc, item) => acc + item.tickets.length, 0)}</p>
          ...
          {state.cart.map((item) => (
            ...
            >
            <CardContent className={`flex flex-col ${isSmallScreen ? 'items-center' : 'sm:flex-row justify-between items-center'}`}>
              ...
              <Box className="flex flex-col items-center sm:items-end mr-4 p-2 rounded">
              ...
              <IconButton
                ...
                className={isSmallScreen ? 'self-end' : ''}
              >
                <Delete />
              </IconButton>
              </Tooltip>
